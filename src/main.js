    ...
    (() => {
        const timer = setInterval(() => {
            if(
                ...
                document.querySelector("div.el-select-dropdown.el-popper") != undefined &&
                ...
                if (document.querySelector("div.el-select-dropdown.el-popper").getAttribute("x-placement") == undefined)
                    ...
                    document.querySelector("div.el-select-dropdown.el-popper > div.el-scrollbar > div > ul > li:nth-child(2)").click()
            }
            if (document.querySelector("#app > div > div.ele-admin-main > div.ele-admin-body > div.ele-admin-content > div.ele-admin-content-view > div > div.el-card.is-never-shadow > div > div:nth-child(1) > form > div:nth-child(1) > div > div > div > input")?.value == "快刷模式") clearInterval(timer);
        }, 500);
    })();
